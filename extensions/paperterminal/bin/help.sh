...
say 1 10 "$LRULE"
say 1 12 "BOARDS: PICK ARRIVALS OR DEPARTURES IN KUAL."
say 1 13 "THE BOARD STAYS ON SCREEN UNTIL YOU PRESS"
say 1 14 "A KEY, WHICH REDRAWS THE NORMAL KINDLE UI."
say 1 16 "ROW FORMAT:"
say 1 17 "  PIC TIME  FLIGHT   AIRLINE      TYPE RWY"
say 1 18 "  \v = ARRIVAL     /^ = DEPARTURE"
say 1 20 "DEMO MODE WORKS OFFLINE WITH SAMPLE DATA."
say 1 21 "LIVE MODE FETCHES FROM YOUR FEED PROXY OVER"
say 1 22 "PLAIN HTTP (SEE server/feed_proxy.py). THE"
say 1 23 "KINDLE 3 CANNOT DO MODERN HTTPS, AND 3G ONLY"
say 1 24 "REACHES AMAZON - USE WI-FI FOR LIVE MODE."
